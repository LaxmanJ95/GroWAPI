...
//	private static Properties properties = new Properties();
	...
	public static String USER_UPLOAD_WEB_ROOT="image_uploads/product_images";
	public static String PRODUCT_IMAGES_WEB_ROOT="image_uploads/product_images";
	...
	public static String createDirectory(String baseDir){
	 ...
	 public static String getBaseUploadDirectory(){
		 ...
		 Properties properties = new Properties();
			...
			try{
			locationProperties = EBIZUtil.getConfigDIR() + "/location.properties";
